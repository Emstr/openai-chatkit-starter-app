  ...
  if (talks.length === 0) {
    return (
      <div className="min-h-screen">
        <div className="bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 py-32 mb-8">
          <div className="container mx-auto px-6 max-w-6xl">
            <h1 className="text-4xl font-bold text-white">FAAA Agenda</h1>
            <p className="text-white/90 text-lg mt-2">Your complete schedule at a glance</p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-0">
            ...
            <div className="flex gap-3">
              ...
              <Link
                href="/speakers"
                className="px-4 py-2 bg-white text-orange-600 rounded-lg hover:bg-gray-50 transition-colors shadow-sm hover:shadow-md font-medium"
              >
                View Speakers
              </Link>
            </div>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b-2 border-gray-300">
                    ...
                    <th className="text-left py-4 px-6 font-semibold text-gray-700">Talk</th>
                    <th className="text-left py-4 px-6 font-semibold text-gray-700">Speakers</th>
